    ...
    <section class="bg-cover bg-center" style="background-image: url('{{ asset('img/home/pexels-photo-5945640.jpeg') }}');">
        <div class="max-w-7xl mx-auto px-4 py-36 sm:px-6 lg:px-8 text-white">
            <div class="w-full md:w-3/4 lg:w-1/2">
                <h1 class="font-bold text-4xl">Directo al campo</h1>
            </div>
        </div>
    </section>

    <section class="py-12">
        <h1 class="text-gray-600 text-center text-3xl mb-6">Aviso de Privacidad</h1>

        <div class="max-w-7xl  text text-center">
           
                <p class="text text-justify text-gray-500 px-20 text-2xl" >
                    IDENTIDAD Y DOMICILIO DEL RESPONSABLE.
                    Directoalcampo.org  (en adelante la “Marca”) con domicilio en calle Real Mayorazgo No. 130, Abasolo Guanajuato 36970, los datos personales y personales sensibles, de nuestros consumidores y posibles consumidores (en adelante “datos personales”), son tratados de forma estrictamente privada y confidencial, por lo que la obtención, tratamiento, transferencia y ejercicio de los derechos derivados de dichos datos personales, se hace mediante un uso adecuado, legítimo y lícito, salvaguardando permanentemente los principios de licitud, consentimiento, calidad, información, proporcionalidad, responsabilidad, lealtad y finalidad, de conformidad con lo dispuesto por la Ley Federal de Protección de Datos Personales en Posesión de los Particulares, su Reglamento y disposiciones secundarias.
                    
                    OBTENCIÓN DE DATOS PERSONALES Y FINALIDADES DE SU TRATAMIENTO.
                    En Directo al campo estamos comprometidos con salvaguardar la privacidad de sus datos personales y mantener una relación estrecha y activa con nuestros consumidores y posibles consumidores por eso además de éste Aviso, aplicamos nuestra Política de Privacidad, te invitamos a conocerla.
                    
                    A continuación, señalamos expresa y limitativamente los datos que podremos recabar de usted como consumidor y posible consumidor:
                    
                    Datos Personales de identificación y contacto:
                    Nombre, apellido paterno y materno, género, edad, fecha de nacimiento, domicilio completo, número telefónico, número celular y correo electrónico.
                    Datos de Facturación (cuando el titular de los Datos así lo solicite):
                    Registro Federal de Contribuyentes.
                    Domicilio fiscal
                    Datos sensibles como:
                    Tipo o condición actual de piel o cabello, en su caso.
                    Con respecto de los datos personales antes mencionados, se garantiza un tratamiento, ya sea directa o indirectamente a través de DIRECTO AL CAMPO MÉXICO, sus subsidiarias, afiliadas o empresas relacionadas, y sus terceros proveedores de servicios con quienes tiene una relación jurídica; obran y tratan datos personales por cuenta de DIRECTO AL CAMPO MÉXICO, así como, en su caso, por las autoridades competentes, para las finalidades que dieron origen y son necesarias para la existencia, mantenimiento y cumplimiento de la relación jurídica con sus consumidores y posibles consumidores, que son las siguientes:
                    
                    Para dar cumplimiento a la relación jurídica establecida con usted, derivado, en su caso, de la adquisición de los productos de la Marca, así como para proveerle información sobre los mismos.
                    Para atender quejas o recomendaciones respecto del uso y aplicación de los productos de la Marca.
                    En caso de adquisición de productos de la Marca, para fines de entrega y facturación de los mismos.
                    De manera adicional, DIRECTO AL CAMPO MÉXICO podrá tratar sus datos personales para las siguientes finalidades distintas o secundarias, que no son necesarias para la existencia, mantenimiento y cumplimiento de la relación jurídica con sus consumidores, pero que nos permiten brindarle una mejor atención:
                    
                    Mercadotecnia, publicidad, prospección comercial, evaluación de nuestros productos y servicios relacionados con la Marca o cualquier otra marca comercializada y distribuida por DIRECTO AL CAMPO MÉXICO, incluyendo el envío de muestras gratis, artículos promocionales u obsequios.
                    Invitación a eventos.
                    Para fines comerciales y de prospección comercial incluso respecto de cualquier otra marca comercializada y distribuida por DIRECTO AL CAMPO MÉXICO.
                    La negativa otorgada para el tratamiento de sus datos personales para las finalidades distintas o secundarias señaladas previamente, no podrá ser un motivo para que le neguemos los productos o servicios derivados de la adquisición de los productos o servicios que adquiere o contrata con nosotros.
                    
                    Derivado de lo anterior, DIRECTO AL CAMPO MÉXICO, le informa que, en caso de que usted no desee que sus datos personales sean tratados para las finalidades distintas o secundarias que se precisan en el presente documento, le solicitamos nos envíe un correo electrónico a la dirección proteccion.datos@loreal.com, a efecto de que nuestro “Oficial de Protección de Datos Personales” documente dicha situación mediante su inscripción en nuestro listado de exclusión denominado “Contactos que no desean envío de publicidad”.
                    
                    Es importante mencionar que, en caso de que DIRECTO AL CAMPO MÉXICO, pretendiera utilizar sus datos personales sensibles para las finalidades secundarias descritas con anterioridad, previo a su tratamiento, solicitará su consentimiento expreso y por escrito de conformidad con la Ley Federal de Protección de Datos Personales en Posesión de los Particulares, su Reglamento y demás disposiciones secundarias obligatorias, de lo contrario no hará uso de los mismos para estos fines.
                    ...
                    Cuando la transferencia sea efectuada a sociedades controladoras, subsidiarias o afiliadas bajo el control común del responsable, o a una sociedad matriz o a cualquier sociedad del mismo grupo de DIRECTO AL CAMPO MÉXICO que opere bajo los mismos procesos y políticas internas.
                    Cuando la transferencia sea necesaria por virtud de un contrato celebrado o por celebrar en interés del titular de datos, por DIRECTO AL CAMPO MÉXICO y un tercero.
                    ...
                    Cuando la transferencia sea precisa para el mantenimiento o cumplimiento de una relación jurídica entre DIRECTO AL CAMPO MÉXICO y el titular de datos.
                    MECANISMOS Y PROCEDIMIENTOS PARA LA REVOCACIÓN DEL CONSENTIMIENTO AL TRATAMIENTO DE DATOS PERSONALES Y/O EJERCICIO DE DERECHOS ARCO.
