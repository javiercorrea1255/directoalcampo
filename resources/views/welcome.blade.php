        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-8">
            <article>
                <figure>
                    ...
                    <img class="rounded-xl h-70 w-full object-cover" src="{{ asset('img/home/anech.png') }}" alt="">
                </a>
                </figure>
                <header class="mt-2">
            ...
            <article>
                <figure>
                    ...
                    <img class="rounded-xl h-70 w-full object-cover" src="{{ asset('img/home/somproagri.jpg') }}" alt="">
                </a>
                <header class="mt-2">
            ...
            <article>
                <figure>
                    ...
                    <img class="rounded-xl h-70 w-full object-cover" src="{{ asset('img/home/conaprenc.jpg') }}" alt="">
                </a>
                </figure>
                <header class="mt-2">
            ...
            <article>
                <figure>
                    ...
                    <img class="rounded-xl h-70 w-full object-cover" src="{{ asset('img/home/red.jpg') }}" alt="">
                </a>
                </figure>
                <header class="mt-2">
...
<script>
    ...
    fbq('init', '1326494911098813');
    fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
    src="https://www.facebook.com/tr?id=1326494911098813&ev=PageView&noscript=1"
    /></noscript>
