...
<div>
    ...
    <section class="container py-12">
        <a href='https://wa.me/message/7RJ2PATTDN64P1' class="bg-blue-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-lg focus:outline-none">Solicita tu constancia</a>
    </section>
    <section class="container py-12">
